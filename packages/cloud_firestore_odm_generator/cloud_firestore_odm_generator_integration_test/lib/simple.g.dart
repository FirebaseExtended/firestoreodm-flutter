...
/// getting document references, and querying for documents
/// (using the methods inherited from Query).
abstract class StaticGetterCollectionReference
    implements
        StaticGetterQuery,
        FirestoreCollectionReference<StaticGetter, StaticGetterQuerySnapshot> {
  factory StaticGetterCollectionReference([
    FirebaseFirestore? firestore,
  ]) = _$StaticGetterCollectionReference;

  static StaticGetter fromFirestore(
    DocumentSnapshot<Map<String, Object?>> snapshot,
    SnapshotOptions? options,
  ) {
    return _$StaticGetterFromJson(snapshot.data()!);
  }
  ...
  static Map<String, Object?> toFirestore(
    ...
    return _$StaticGetterToJson(value);
  }

  @override
  CollectionReference<StaticGetter> get reference;

  @override
  StaticGetterDocumentReference doc([String? id]);

  /// Add a new document to this collection with the specified data,
  /// assigning it a document ID automatically.
  Future<StaticGetterDocumentReference> add(StaticGetter value);
}

class _$StaticGetterCollectionReference extends _$StaticGetterQuery
    implements StaticGetterCollectionReference {
  factory _$StaticGetterCollectionReference([FirebaseFirestore? firestore]) {
    firestore ??= FirebaseFirestore.instance;

    return _$StaticGetterCollectionReference._(
      firestore.collection('root').withConverter(
            fromFirestore: StaticGetterCollectionReference.fromFirestore,
            toFirestore: StaticGetterCollectionReference.toFirestore,
          ),
    );
  }

  _$StaticGetterCollectionReference._(
    CollectionReference<StaticGetter> reference,
  ) : super(reference, $referenceWithoutCursor: reference);
  ...
  @override
  CollectionReference<StaticGetter> get reference =>
      super.reference as CollectionReference<StaticGetter>;
  ...
  StaticGetterDocumentReference doc([String? id]) {
    ...
    return StaticGetterDocumentReference(
      reference.doc(id),
    );
  }
  ...
  Future<StaticGetterDocumentReference> add(StaticGetter value) {
    return reference
        .add(value)
        .then((ref) => StaticGetterDocumentReference(ref));
  }

  @override
  bool operator ==(Object other) {
    return other is _$StaticGetterCollectionReference &&
        other.runtimeType == runtimeType &&
        other.reference == reference;
  }
...
abstract class StaticGetterDocumentReference extends FirestoreDocumentReference<
    StaticGetter, StaticGetterDocumentSnapshot> {
  factory StaticGetterDocumentReference(
          DocumentReference<StaticGetter> reference) =
      _$StaticGetterDocumentReference;

  DocumentReference<StaticGetter> get reference;

  /// A reference to the [StaticGetterCollectionReference] containing this document.
  StaticGetterCollectionReference get parent {
    return _$StaticGetterCollectionReference(reference.firestore);
  }

  @override
  Stream<StaticGetterDocumentSnapshot> snapshots();

  @override
  Future<StaticGetterDocumentSnapshot> get([GetOptions? options]);
...
class _$StaticGetterDocumentReference extends FirestoreDocumentReference<
    StaticGetter,
    StaticGetterDocumentSnapshot> implements StaticGetterDocumentReference {
  _$StaticGetterDocumentReference(this.reference);

  @override
  final DocumentReference<StaticGetter> reference;
  ...
  @override
  Stream<StaticGetterDocumentSnapshot> snapshots() {
    return reference.snapshots().map(StaticGetterDocumentSnapshot._);
  }

  @override
  Future<StaticGetterDocumentSnapshot> get([GetOptions? options]) {
    return reference.get(options).then(StaticGetterDocumentSnapshot._);
  }

  @override
  Future<StaticGetterDocumentSnapshot> transactionGet(Transaction transaction) {
    return transaction.get(reference).then(StaticGetterDocumentSnapshot._);
  }
  ...
  Future<void> set(
    ...
    final json = {
      ..._$StaticGetterToJson(model),
      if (instanceGetterFieldValue != null)
        _$StaticGetterFieldMap['instanceGetter']!: instanceGetterFieldValue,
    };
  ...
  Future<void> update({
    ...
    final json = {
      if (instanceGetter != _sentinel)
        _$StaticGetterFieldMap['instanceGetter']!:
            _$StaticGetterPerFieldToJson.instanceGetter(instanceGetter as num),
      if (instanceGetterFieldValue != null)
        _$StaticGetterFieldMap['instanceGetter']!: instanceGetterFieldValue,
    };
  ...
  @override
  bool operator ==(Object other) {
    return other is StaticGetterDocumentReference &&
        other.runtimeType == runtimeType &&
        other.parent == parent &&
        other.id == id;
  }
...
abstract class StaticGetterQuery
    implements QueryReference<StaticGetter, StaticGetterQuerySnapshot> {
  @override
  StaticGetterQuery limit(int limit);

  @override
  StaticGetterQuery limitToLast(int limit);
  ...
  /// collection.whereTitle(isEqualTo: 'title');
  /// ```
  StaticGetterQuery whereFieldPath(
    Object fieldPath, {
    Object? isEqualTo,
    Object? isNotEqualTo,
    Object? isLessThan,
  ...
  StaticGetterQuery whereDocumentId({
    String? isEqualTo,
    String? isNotEqualTo,
    String? isLessThan,
    String? isLessThanOrEqualTo,
  ...
  StaticGetterQuery whereInstanceGetter({
    num? isEqualTo,
    num? isNotEqualTo,
    num? isLessThan,
    num? isLessThanOrEqualTo,
  ...
  /// collection.orderByTitle(startAt: 'title');
  /// ```
  StaticGetterQuery orderByFieldPath(
    Object fieldPath, {
    bool descending = false,
    Object startAt,
    Object startAfter,
    Object endAt,
    Object endBefore,
    StaticGetterDocumentSnapshot? startAtDocument,
    StaticGetterDocumentSnapshot? endAtDocument,
    StaticGetterDocumentSnapshot? endBeforeDocument,
    StaticGetterDocumentSnapshot? startAfterDocument,
  });

  StaticGetterQuery orderByDocumentId({
    bool descending = false,
    String startAt,
    String startAfter,
    String endAt,
  ...
  StaticGetterQuery orderByInstanceGetter({
    bool descending = false,
    num startAt,
    num startAfter,
    num endAt,
...
class _$StaticGetterQuery
    extends QueryReference<StaticGetter, StaticGetterQuerySnapshot>
    implements StaticGetterQuery {
  _$StaticGetterQuery(
    this._collection, {
    required Query<StaticGetter> $referenceWithoutCursor,
    $QueryCursor $queryCursor = const $QueryCursor(),
  }) : super(
          $referenceWithoutCursor: $referenceWithoutCursor,
          $queryCursor: $queryCursor,
  ...
  @override
  Stream<StaticGetterQuerySnapshot> snapshots([SnapshotOptions? options]) {
    return reference
        .snapshots()
        .map(StaticGetterQuerySnapshot._fromQuerySnapshot);
  }

  @override
  Future<StaticGetterQuerySnapshot> get([GetOptions? options]) {
    return reference
        .get(options)
        .then(StaticGetterQuerySnapshot._fromQuerySnapshot);
  }

  @override
  StaticGetterQuery limit(int limit) {
    return _$StaticGetterQuery(
      _collection,
      $referenceWithoutCursor: $referenceWithoutCursor.limit(limit),
      $queryCursor: $queryCursor,
    );
  ...
  StaticGetterQuery whereInstanceGetter({
    ...
    return _$StaticGetterQuery(
      ...
      $referenceWithoutCursor: $referenceWithoutCursor.where(
        _$StaticGetterFieldMap['instanceGetter']!,
        isEqualTo: isEqualTo != _sentinel
            ? _$StaticGetterPerFieldToJson.instanceGetter(isEqualTo as num)
            : null,
        isNotEqualTo: isNotEqualTo != _sentinel
            ? _$StaticGetterPerFieldToJson.instanceGetter(isNotEqualTo as num)
            : null,
        isLessThan: isLessThan != null
            ? _$StaticGetterPerFieldToJson.instanceGetter(isLessThan as num)
            : null,
        isLessThanOrEqualTo: isLessThanOrEqualTo != null
            ? _$StaticGetterPerFieldToJson
                .instanceGetter(isLessThanOrEqualTo as num)
            : null,
        isGreaterThan: isGreaterThan != null
            ? _$StaticGetterPerFieldToJson.instanceGetter(isGreaterThan as num)
            : null,
        isGreaterThanOrEqualTo: isGreaterThanOrEqualTo != null
            ? _$StaticGetterPerFieldToJson
                .instanceGetter(isGreaterThanOrEqualTo as num)
            : null,
        whereIn:
            whereIn?.map((e) => _$StaticGetterPerFieldToJson.instanceGetter(e)),
        whereNotIn: whereNotIn
            ?.map((e) => _$StaticGetterPerFieldToJson.instanceGetter(e)),
        isNull: isNull ??
            (isEqualTo == null ? false : null) ??
            (isNotEqualTo == null ? true : null),
      ),
  ...
  @override
  bool operator ==(Object other) {
    return other is _$StaticGetterQuery &&
        other.runtimeType == runtimeType &&
        other.reference == reference;
  }
...
class StaticGetterDocumentSnapshot
    extends FirestoreDocumentSnapshot<StaticGetter> {
  StaticGetterDocumentSnapshot._(this.snapshot) : data = snapshot.data();

  @override
  final DocumentSnapshot<StaticGetter> snapshot;

  @override
  StaticGetterDocumentReference get reference {
    return StaticGetterDocumentReference(
      snapshot.reference,
    );
  }
  ...
  @override
  final StaticGetter? data;
}

class StaticGetterQuerySnapshot extends FirestoreQuerySnapshot<StaticGetter,
    StaticGetterQueryDocumentSnapshot> {
  StaticGetterQuerySnapshot._(
    this.snapshot,
    this.docs,
    this.docChanges,
  );

  factory StaticGetterQuerySnapshot._fromQuerySnapshot(
    QuerySnapshot<StaticGetter> snapshot,
  ) {
    final docs =
        snapshot.docs.map(StaticGetterQueryDocumentSnapshot._).toList();

    final docChanges = snapshot.docChanges.map((change) {
      return _decodeDocumentChange(
        change,
        StaticGetterDocumentSnapshot._,
      );
    }).toList();

    return StaticGetterQuerySnapshot._(
      snapshot,
      docs,
      docChanges,
    );
  ...
  static FirestoreDocumentChange<StaticGetterDocumentSnapshot>
      _decodeDocumentChange<T>(
    DocumentChange<T> docChange,
    StaticGetterDocumentSnapshot Function(DocumentSnapshot<T> doc) decodeDoc,
  ) {
    return FirestoreDocumentChange<StaticGetterDocumentSnapshot>(
      type: docChange.type,
      oldIndex: docChange.oldIndex,
      newIndex: docChange.newIndex,
      doc: decodeDoc(docChange.doc),
  ...
  final QuerySnapshot<StaticGetter> snapshot;

  @override
  final List<StaticGetterQueryDocumentSnapshot> docs;

  @override
  final List<FirestoreDocumentChange<StaticGetterDocumentSnapshot>> docChanges;
}

class StaticGetterQueryDocumentSnapshot
    extends FirestoreQueryDocumentSnapshot<StaticGetter>
    implements StaticGetterDocumentSnapshot {
  StaticGetterQueryDocumentSnapshot._(this.snapshot) : data = snapshot.data();

  @override
  final QueryDocumentSnapshot<StaticGetter> snapshot;
  ...
  @override
  StaticGetterDocumentReference get reference {
    return StaticGetterDocumentReference(snapshot.reference);
  }
}
...
StaticGetter _$StaticGetterFromJson(Map<String, dynamic> json) => StaticGetter(
      json['instanceGetter'] as num,
    );

const _$StaticGetterFieldMap = <String, String>{
  'instanceGetter': 'instanceGetter',
};

// ignore: unused_element
abstract class _$StaticGetterPerFieldToJson {
  // ignore: unused_element
  static Object? instanceGetter(num instance) => instance;
}

Map<String, dynamic> _$StaticGetterToJson(StaticGetter instance) =>
    <String, dynamic>{
